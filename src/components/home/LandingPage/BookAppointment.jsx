  ...
  return (
    ...
    <div className="lg:flex justify-between pb-[50px] items-center mt-3 lg:mb-[3vw] lg:mx-16 mx-4">
        ...
        <PopupButton
          ...
          className="relative w-fit px-5  lg:py-2 py-0 overflow-hidden border border-zinc-800 rounded-full text-[#17191b] transition-all before:absolute before:top-0 before:left-0 before:right-0 before:z-0 before:h-full before:w-0 before:bg-black before:transition-all before:duration-500 hover:text-white hover:before:left-0 hover:before:w-full"
          text={
