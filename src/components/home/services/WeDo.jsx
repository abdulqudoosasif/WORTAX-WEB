...
const WeDo = () => {
  return (
    <div className="md:w-[38vw] w-[calc(100%-20px)] lg:w-[23vw] relative h-auto">
      ...
      <div className="md:w-[38vw] w-[calc(100%-20px)] lg:w-[23vw] group relative border border-zinc-400 p-2 xl:p-4 lg:p-3 bg-neutral-900 hover:bg-opacity-75 duration-200 overflow-hidden flex justify-center items-center">
