...
function Marquee() {
  ...
  return (
    <div data-scroll data-scroll-section   className='w-full xl:-mt-[4vw] lg:-mt-4 py-12 lg:py-20 pb-28 md:mb-[40px] lg:mb-0 rounded-t-3xl bg-neutral-900  relative z-20'>
