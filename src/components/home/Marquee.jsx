...
function Marquee() {
  ...
  return (
    <div data-scroll data-scroll-section  className='w-full py-12 lg:py-20 pb-28 md:mb-[40px] lg:mb-0 rounded-t-3xl bg-neutral-900 lg:mt-16 mt-12 relative z-20'>
