...
function About() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed='0.35'
      className='bg-gray-50 rounded-t-3xl xl:-top-[8vw]  lg:-top-[10vw] md:-mt-[15vw] overflow-hidden relative px-[5vw]  z-20 '>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className='w-full flex flex-wrap items-center justify-center lg:gap-[1.8vw] gap-5 lg:py-[3vw] py-10'>
            <div className='lg:w-[calc(33%-3vw)] md:w-[calc(50%-3vw)] w-[calc(100%-3vw)] flex flex-col items-center  lg:gap-[1.8vw] gap-5 lg:px-[1.9vw] px-3 lg:pt-[4vw] pt-10 lg:pb-[6vw] pb-12 border rounded-lg lg:hover:scale-105 lg:hover:shadow-2xl shadow-slate-400 duration-300' >
              ...
              <h5 className='lg:text-[1.5vw] md:text-xl text-base tracking-[0.08vw]'>Speed and Precision</h5>
              <p className="lg:text-[1.2vw] md:text-sm text-xs lg:leading-[1.5vw]  text-[#5f656c] text-center lg:px-[1.5vw] px-6">
            ...
            <div className='lg:w-[calc(33%-3vw)] md:w-[calc(50%-3vw)] w-[calc(100%-3vw)] flex flex-col items-center  lg:gap-[1.8vw] gap-5 lg:px-[1.9vw] px-3 lg:pt-[4vw] pt-10 lg:pb-[6vw] pb-12 border rounded-lg lg:hover:scale-105 lg:hover:shadow-2xl shadow-slate-400 duration-300' >
              ...
              <h5 className='lg:text-[1.5vw] md:text-xl text-base tracking-[0.08vw]'>Digital Scouting Expertise</h5>
              <p className="lg:text-[1.2vw] md:text-sm text-xs lg:leading-[1.5vw]  text-[#5f656c] text-center lg:px-[1.5vw] px-6">
            ...
            <div className='lg:w-[calc(33%-3vw)] md:w-[calc(50%-3vw)] w-[calc(100%-3vw)] flex flex-col items-center  lg:gap-[1.8vw] gap-5 lg:px-[1.9vw] px-3 lg:pt-[4vw] pt-10 lg:pb-[6vw] pb-12 border rounded-lg lg:hover:scale-105 lg:hover:shadow-2xl shadow-slate-400 duration-300' >
              ...
              <h5 className='lg:text-[1.5vw] md:text-xl text-base tracking-[0.08vw]'>Solutions That Transform</h5>
              <p className="lg:text-[1.2vw] md:text-sm text-xs lg:leading-[1.5vw]  text-[#5f656c] text-center lg:px-[1.5vw] px-6">
            ...
            <div className='lg:w-[calc(33%-3vw)] md:w-[calc(50%-3vw)] w-[calc(100%-3vw)] flex flex-col items-center  lg:gap-[1.8vw] gap-5 lg:px-[1.9vw] px-3 lg:pt-[4vw] pt-10 lg:pb-[6vw] pb-12 border rounded-lg lg:hover:scale-105 lg:hover:shadow-2xl shadow-slate-400 duration-300' >
              ...
              <h5 className='lg:text-[1.5vw] md:text-xl text-base tracking-[0.08vw]'>Personalized Partnership</h5>
              <p className="lg:text-[1.2vw] md:text-sm text-xs lg:leading-[1.5vw]  text-[#5f656c] text-center lg:px-[1.5vw] px-6">
            ...
            <div className='lg:w-[calc(33%-3vw)] md:w-[calc(50%-3vw)] w-[calc(100%-3vw)] flex flex-col items-center  lg:gap-[1.8vw] gap-5 lg:px-[1.9vw] px-3 lg:pt-[4vw] pt-10 lg:pb-[6vw] pb-12 border rounded-lg lg:hover:scale-105 lg:hover:shadow-2xl shadow-slate-400 duration-300' >
              ...
              <h5 className='lg:text-[1.5vw] md:text-xl text-base tracking-[0.08vw]'>Industry Expertise</h5>
              <p className="lg:text-[1.2vw] md:text-sm text-xs lg:leading-[1.5vw]  text-[#5f656c] text-center lg:px-[1.5vw] px-6">
