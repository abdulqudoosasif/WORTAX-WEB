              ...
              <div className="flex justify-between items-center py-6">
                <div className="flex justify-start">
                  <a href="#">
                    ...
                    <img className="w-auto h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="" />
                  </a>
                </div>
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Transition
                          ...
                          <Popover.Panel static className="absolute -ml-4 mt-3 transform z-0  w-screen max-w-md px-0">
                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                              ...
                              <div className=" py-5 bg-gray-50  flex  space-x-10 px-8">
                    ...
                    {({ open }) => (
                      <>
                        ...
                        <Transition
                          ...
                          <Popover.Panel
                            static
                            className="absolute left-1/2 z-0 transform -translate-x-1/2 mt-3 w-screen max-w-md px-0">
                            <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                              <div className="relative grid  bg-white px-5 py-6 gap-8 p-8">
                                {resources.map((item) => (
                                  <a key={item.name} href={item.href} className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
        ...
        <div className="mx-auto max-w-7xl w-full pt-16 pb-20 text-center">
          <div className=" px-8">
            <h1 className=" tracking-tight font-extrabold text-gray-900 text-5xl">
              <span className="block">WORTAX IT</span> <span className="block text-indigo-600">SOLUTION</span>
            </h1>
