...
const EyesMovement = () => {
  ...
  return (
    <div className='overflow-hidden w-full flex gap-10 items-center justify-center py-20'>
      <div className='w-[22vw] h-[22vw] rounded-full border-2 border-[#d7d7d7] bg-[#f4f4f4] flex justify-center items-center'>
